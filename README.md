...
```
JP-VN/
├── 📄 VN_TRANSLATOR_MASTER_INSTRUCTION_MINIFIED.xml  # Core logic (17KB)
...
│
└── 🔧 Utilities/
    ├── VN_LN_Master_Prompt_v10.0_LIGHTWEIGHT.md      # Phiên bản nhẹ
    └── KANJI_LOOKUP_VN.json                          # JSON lookup table
```
